...
KeywordSet0:
	...
	.text	8,$0c,"SCREEN$("       ; $a7 SCREEN$(
	.text	7,$e8,"SCREEN("        ; $a8 SCREEN(
	.text	4,$10,"SGN("           ; $a9 SGN(
	.text	4,$0e,"SPC("           ; $aa SPC(
	.text	5,$45,"STR$("          ; $ab STR$(
	.text	5,$56,"TILE("          ; $ac TILE(
	.text	6,$a9,"TIMER("         ; $ad TIMER(
	.text	4,$40,"TRUE"           ; $ae TRUE
	.text	4,$0b,"VAL("           ; $af VAL(
	.text	3,$e7,"FOR"            ; $b0 FOR
	.text	2,$8f,"IF"             ; $b1 IF
	.text	4,$34,"PROC"           ; $b2 PROC
	.text	6,$c1,"REPEAT"         ; $b3 REPEAT
	.text	5,$79,"WHILE"          ; $b4 WHILE
	.text	5,$66,"ENDIF"          ; $b5 ENDIF
	.text	7,$0b,"ENDPROC"        ; $b6 ENDPROC
	.text	4,$3f,"NEXT"           ; $b7 NEXT
	.text	4,$2f,"THEN"           ; $b8 THEN
	.text	5,$8c,"UNTIL"          ; $b9 UNTIL
	.text	4,$2e,"WEND"           ; $ba WEND
	.text	2,$95,"AT"             ; $bb AT
	.text	2,$9b,"BY"             ; $bc BY
	.text	4,$1c,"CALL"           ; $bd CALL
	.text	6,$b2,"CIRCLE"         ; $be CIRCLE
	.text	5,$67,"CLEAR"          ; $bf CLEAR
	.text	5,$7f,"COLOR"          ; $c0 COLOR
	.text	6,$d4,"COLOUR"         ; $c1 COLOUR
	.text	4,$1a,"DATA"           ; $c2 DATA
	.text	3,$da,"DIM"            ; $c3 DIM
	.text	6,$db,"DOWNTO"         ; $c4 DOWNTO
	.text	4,$29,"ELSE"           ; $c5 ELSE
	.text	4,$34,"FROM"           ; $c6 FROM
	.text	3,$e5,"GFX"            ; $c7 GFX
	.text	4,$24,"HERE"           ; $c8 HERE
	.text	5,$63,"IMAGE"          ; $c9 IMAGE
	.text	3,$e5,"LET"            ; $ca LET
	.text	4,$28,"LINE"           ; $cb LINE
	.text	5,$6b,"LOCAL"          ; $cc LOCAL
	.text	7,$1a,"MEMCOPY"        ; $cd MEMCOPY
	.text	3,$db,"OFF"            ; $ce OFF
	.text	2,$9d,"ON"             ; $cf ON
	.text	7,$20,"OUTLINE"        ; $d0 OUTLINE
	.text	7,$0f,"PALETTE"        ; $d1 PALETTE
	.text	4,$3f,"PLOT"           ; $d2 PLOT
	.text	4,$2f,"POKE"           ; $d3 POKE
	.text	5,$73,"POKED"          ; $d4 POKED
	.text	5,$7b,"POKEL"          ; $d5 POKEL
	.text	5,$86,"POKEW"          ; $d6 POKEW
	.text	4,$1c,"READ"           ; $d7 READ
	.text	4,$2e,"RECT"           ; $d8 RECT
	.text	3,$e4,"REM"            ; $d9 REM
	.text	5,$7b,"SOLID"          ; $da SOLID
	.text	5,$89,"SOUND"          ; $db SOUND
	.text	6,$d7,"SPRITE"         ; $dc SPRITE
	.text	4,$45,"TEXT"           ; $dd TEXT
	.text	2,$a3,"TO"             ; $de TO
	.text	$FF
KeywordSet1:
	.text	0,$65,""               ; $80 !0:EOF
