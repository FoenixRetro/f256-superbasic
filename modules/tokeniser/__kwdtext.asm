...
KeywordSet0:
	...
	.text	8,$3c,"PLAYING("       ; $96 PLAYING(
	.text	7,$e9,"RANDOM("        ; $97 RANDOM(
	.text	7,$ca,"RIGHT$("        ; $98 RIGHT$(
	.text	4,$0c,"RND("           ; $99 RND(
	.text	4,$10,"SGN("           ; $9a SGN(
	.text	4,$0e,"SPC("           ; $9b SPC(
	.text	5,$45,"STR$("          ; $9c STR$(
	.text	6,$a9,"TIMER("         ; $9d TIMER(
	.text	4,$40,"TRUE"           ; $9e TRUE
	.text	4,$0b,"VAL("           ; $9f VAL(
	.text	3,$e7,"FOR"            ; $a0 FOR
	.text	2,$8f,"IF"             ; $a1 IF
	.text	4,$34,"PROC"           ; $a2 PROC
	.text	6,$c1,"REPEAT"         ; $a3 REPEAT
	.text	5,$79,"WHILE"          ; $a4 WHILE
	.text	5,$66,"ENDIF"          ; $a5 ENDIF
	.text	7,$0b,"ENDPROC"        ; $a6 ENDPROC
	.text	4,$3f,"NEXT"           ; $a7 NEXT
	.text	4,$2f,"THEN"           ; $a8 THEN
	.text	5,$8c,"UNTIL"          ; $a9 UNTIL
	.text	4,$2e,"WEND"           ; $aa WEND
	.text	2,$9b,"BY"             ; $ab BY
	.text	4,$1c,"CALL"           ; $ac CALL
	.text	6,$b2,"CIRCLE"         ; $ad CIRCLE
	.text	5,$67,"CLEAR"          ; $ae CLEAR
	.text	3,$e2,"CLS"            ; $af CLS
	.text	5,$7f,"COLOR"          ; $b0 COLOR
	.text	6,$d4,"COLOUR"         ; $b1 COLOUR
	.text	4,$1a,"DATA"           ; $b2 DATA
	.text	3,$da,"DIM"            ; $b3 DIM
	.text	6,$db,"DOWNTO"         ; $b4 DOWNTO
	.text	4,$29,"ELSE"           ; $b5 ELSE
	.text	4,$34,"FROM"           ; $b6 FROM
	.text	3,$e5,"GFX"            ; $b7 GFX
	.text	5,$80,"GOSUB"          ; $b8 GOSUB
...
KeywordSet1:
	...
	.text	2,$96,"GO"             ; $87 GO
	.text	4,$3c,"LIST"           ; $88 LIST
	.text	4,$20,"LOAD"           ; $89 LOAD
	.text	3,$ea,"NEW"            ; $8a NEW
	.text	7,$24,"RESTORE"        ; $8b RESTORE
