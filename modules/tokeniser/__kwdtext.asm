...
KeywordSet0:
	...
	.text	5,$4d,"PEEK("          ; $96 PEEK(
	.text	6,$91,"PEEKD("         ; $97 PEEKD(
	.text	6,$99,"PEEKL("         ; $98 PEEKL(
	.text	6,$a4,"PEEKW("         ; $99 PEEKW(
	.text	8,$3c,"PLAYING("       ; $9a PLAYING(
	.text	7,$e9,"RANDOM("        ; $9b RANDOM(
	.text	7,$ca,"RIGHT$("        ; $9c RIGHT$(
	.text	4,$0c,"RND("           ; $9d RND(
	.text	4,$10,"SGN("           ; $9e SGN(
	.text	4,$0e,"SPC("           ; $9f SPC(
	.text	5,$45,"STR$("          ; $a0 STR$(
	.text	6,$a9,"TIMER("         ; $a1 TIMER(
	.text	4,$40,"TRUE"           ; $a2 TRUE
	.text	4,$0b,"VAL("           ; $a3 VAL(
	.text	3,$e7,"FOR"            ; $a4 FOR
	.text	2,$8f,"IF"             ; $a5 IF
	.text	4,$34,"PROC"           ; $a6 PROC
	.text	6,$c1,"REPEAT"         ; $a7 REPEAT
	.text	5,$79,"WHILE"          ; $a8 WHILE
	.text	5,$66,"ENDIF"          ; $a9 ENDIF
	.text	7,$0b,"ENDPROC"        ; $aa ENDPROC
	.text	4,$3f,"NEXT"           ; $ab NEXT
	.text	4,$2f,"THEN"           ; $ac THEN
	.text	5,$8c,"UNTIL"          ; $ad UNTIL
	.text	4,$2e,"WEND"           ; $ae WEND
	.text	2,$9b,"BY"             ; $af BY
	.text	4,$1c,"CALL"           ; $b0 CALL
	.text	6,$b2,"CIRCLE"         ; $b1 CIRCLE
	.text	5,$67,"CLEAR"          ; $b2 CLEAR
	.text	3,$e2,"CLS"            ; $b3 CLS
	.text	5,$7f,"COLOR"          ; $b4 COLOR
	.text	6,$d4,"COLOUR"         ; $b5 COLOUR
	.text	4,$1a,"DATA"           ; $b6 DATA
	.text	3,$da,"DIM"            ; $b7 DIM
	.text	6,$db,"DOWNTO"         ; $b8 DOWNTO
	.text	4,$29,"ELSE"           ; $b9 ELSE
	.text	4,$34,"FROM"           ; $ba FROM
	.text	3,$e5,"GFX"            ; $bb GFX
	.text	5,$80,"GOSUB"          ; $bc GOSUB
	.text	4,$39,"GOTO"           ; $bd GOTO
	.text	4,$24,"HERE"           ; $be HERE
	.text	5,$63,"IMAGE"          ; $bf IMAGE
	.text	5,$90,"INPUT"          ; $c0 INPUT
	.text	3,$e5,"LET"            ; $c1 LET
	.text	4,$28,"LINE"           ; $c2 LINE
	.text	5,$6b,"LOCAL"          ; $c3 LOCAL
	.text	3,$db,"OFF"            ; $c4 OFF
	.text	2,$9d,"ON"             ; $c5 ON
	.text	7,$20,"OUTLINE"        ; $c6 OUTLINE
	.text	7,$0f,"PALETTE"        ; $c7 PALETTE
	.text	4,$3f,"PLOT"           ; $c8 PLOT
	.text	4,$2f,"POKE"           ; $c9 POKE
	.text	5,$73,"POKED"          ; $ca POKED
	.text	5,$7b,"POKEL"          ; $cb POKEL
	.text	5,$86,"POKEW"          ; $cc POKEW
	.text	5,$8d,"PRINT"          ; $cd PRINT
	.text	4,$1c,"READ"           ; $ce READ
	.text	4,$2e,"RECT"           ; $cf RECT
	.text	3,$e4,"REM"            ; $d0 REM
	.text	6,$e0,"RETURN"         ; $d1 RETURN
