...
_PEDoClearScreen:
		lda 	#$0C 						; remap to Ctrl+L (clear screen)
		jmp 	_PEQueueA
...
_PECheckModArrow:
		pha 								; save arrow key
		jsr 	IsCtrlPressed 				; check if Ctrl held
		beq 	_PENoCtrlArrow 				; Z set = no Ctrl
...
;		Returns: Z clear if Ctrl pressed, Z set if not pressed
;		Preserves: X, Y
;
; ************************************************************************************************
...
;		28/02/26 		Remapped to macOS conventions: Ctrl+arrow=word jump/home/end,
;						FNX+Up/Down=scroll. Added IsCtrlPressed, IsFnxPressed helpers.
;
; ************************************************************************************************
